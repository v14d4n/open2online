...
public final class OpenToOnlineConfig {
    ...
    static {
        ...
        requireLicense = builder.comment("Verify that joining players own the game. Turning this off lets anyone join under any name - use the whitelist. Default value is true.").define("Require License", true);
